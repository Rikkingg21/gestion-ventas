...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <!-- Si no hay aprobadas, mostrar un placeholder -->
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($solicitudes as $solicitud)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $solicitud->cliente->nombre }} {{ $solicitud->cliente->apellidos }}</div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Inicializar tooltips nativos de Tailwind no necesita bootstrap
    // Usaremos el atributo title para los tooltips simples
});
</script>
@endsection
